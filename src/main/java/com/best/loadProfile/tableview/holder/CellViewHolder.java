package com.best.loadProfile.tableview.holder;
...
public class CellViewHolder extends AbstractViewHolder {
    ...
    public void setCellModel(CellModel p_jModel, int pColumnPosition) {
        ...
        if (String.valueOf(p_jModel.getData()).equals("N/A")) {
            cell_textview.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
        }
        else {
            cell_textview.setGravity(Gravity.RIGHT | Gravity.CENTER_VERTICAL);
        }
