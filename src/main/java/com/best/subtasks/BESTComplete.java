...
public class BESTComplete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bestcomplete);

        final ImageButton previous = findViewById(R.id.endBESTPrevious);
    ...
    public void viewResultsClick(View view) {
        Bundle bundle = getIntent().getExtras();
        String date = "";
        String id = "";
        String rveResult = "";
