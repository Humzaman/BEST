...
public class PVEInterim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pve_interim);

        Button button = findViewById(R.id.pveInterimBeginButton);
        ...
        ImageButton next = findViewById(R.id.pve2Next);
        ImageButton previous = findViewById(R.id.pve2Previous);
    ...
    private void pve2BeginClick() {
        ...
        Intent intent = new Intent(this, PVE2Test.class);
        intent.putExtra("bestDate", date);
        intent.putExtra("id", id);
        intent.putExtra("rveResult", rveResult);
        intent.putExtra("pre1Result", pre1Result);
